...
const ll NUM_OPERATIONS = 1000000;
...
int main() {
    ...
    for (ll i = 0; i < NUM_OPERATIONS; i++) {
        vec.push_back(i);
    }
    auto end = high_resolution_clock::now();
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Vector Insertion: " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Vector Access: " << time_taken << " ms/million operations" << endl;
    cout << "Sum (to avoid optimization): " << sum << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Vector Deletion: " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Set Insertion: " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Set Access (find): " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Set Deletion: " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Unordered Set Insertion: " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Unordered Set Access (find): " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Unordered Set Deletion: " << time_taken << " ms/million operations" << endl;

    // Benchmark plain array
    ll arr[NUM_OPERATIONS];
    start = high_resolution_clock::now();
    for (ll i = 0; i < NUM_OPERATIONS; i++) {
        arr[i] = i;
    }
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Array Insertion: " << time_taken << " ms/million operations" << endl;
    ...
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Array Access: " << time_taken << " ms/million operations" << endl;
    cout << "Sum (to avoid optimization): " << sum << endl;

    start = high_resolution_clock::now();
    for (ll i = 0; i < NUM_OPERATIONS; i++) {
        arr[i] = 0; // Simulate deletion by setting to 0
    }
    end = high_resolution_clock::now();
    time_taken = duration_cast<microseconds>(end - start).count() / 1000.0;
    cout << "Array Deletion: " << time_taken << " ms/million operations" << endl;
