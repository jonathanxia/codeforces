...
namespace rado {
    ...
    private:
        void set_random_base() {
            ...
            mt19937 rng(seed);
            base = uniform_int_distribution<uint64_t>(0, mmod - 1)(rng);
        }
    ...
    public:
        ...
        static constexpr uint64_t mmod = (1ull << 61) - 1;
...
using PolynomialHash = rado::hash_meta_t::hash_t;